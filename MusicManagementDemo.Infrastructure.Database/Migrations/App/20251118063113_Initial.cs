...
namespace MusicManagementDemo.Infrastructure.Database.Migrations.App
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrevId = table.Column<Guid>(
                        type: "uuid",
                        nullable: true,
                        defaultValueSql: "NULL"
                    ),
                    NextId = table.Column<Guid>(
                        type: "uuid",
                        nullable: true,
                        defaultValueSql: "NULL"
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleTSV = table.Column<NpgsqlTsVector>(
                        type: "TSVECTOR",
                        nullable: false,
                        computedColumnSql: "to_tsvector('simple', \"Title\")",
                        stored: true
                    ),
                },
                constraints: table =>
        ...
        {
            migrationBuilder.DropTable(name: "Jobs", schema: "management");

            migrationBuilder.DropTable(name: "MusicInfoMusicListMaps", schema: "music");

            migrationBuilder.DropTable(name: "MusicInfos", schema: "music");

            migrationBuilder.DropTable(name: "MusicLists", schema: "music");

            migrationBuilder.DropTable(name: "RoleClaims", schema: "id");

            migrationBuilder.DropTable(name: "Storages", schema: "management");

            migrationBuilder.DropTable(name: "UserClaims", schema: "id");

            migrationBuilder.DropTable(name: "UserLogins", schema: "id");

            migrationBuilder.DropTable(name: "UserRoles", schema: "id");

            migrationBuilder.DropTable(name: "UserTokens", schema: "id");

            migrationBuilder.DropTable(name: "Roles", schema: "id");

            migrationBuilder.DropTable(name: "Users", schema: "id");
        }
    }
}
